...
patientID = 0          # patient's identification number
temp1 = 0.0            # patient's first temperature
temp2 = 0.0            #          second temperature
temp3 = 0.0            # third temperature
...
if dataOK:    # determine results for valid data set
    ...
    average = (temp1 + temp2 + temp3) / float(NUM_TEMPS)
